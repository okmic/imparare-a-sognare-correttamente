...
export const Slide6 = () => (
  <div className="text-center text-white px-4 h-full flex flex-col justify-center bg-[#742353]">
    <div className="max-w-4xl mx-auto w-full">
      <div className="mb-8 sm:mb-12">
        <div className="inline-flex items-center justify-center p-2 sm:p-3 rounded-full bg-gradient-to-r from-amber-500/30 to-orange-500/30 border border-orange-500/30 mb-4 animate-pulse">
      ...
      <div className="relative mb-8 sm:mb-12">
        ...
        <div className="relative bg-gradient-to-br from-orange-900/30 to-amber-900/30 rounded-2xl p-6 sm:p-8 border border-orange-500/30">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
                <div className="relative">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-orange-500/40 to-amber-500/40 flex items-center justify-center">
                    <Users className="w-8 h-8 sm:w-10 sm:h-10 text-orange-200" />
                  </div>
                  <div className="absolute -bottom-2 -right-2 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-amber-500/50 to-yellow-500/50 flex items-center justify-center animate-pulse">
                    <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-amber-200" />
                  </div>
                </div>
                <div>
            ...
            <div className="relative">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-amber-500/30 to-yellow-500/30 flex items-center justify-center animate-spin-slow">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-yellow-500/40 to-amber-500/40 flex items-center justify-center animate-pulse">
                  <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-yellow-200" />
                </div>
              </div>
              <div className="absolute -top-4 -left-4 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-orange-500/40 to-red-500/40 flex items-center justify-center animate-bounce">
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-orange-200" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
        <div className="group relative">
          <div className="bg-gradient-to-br from-amber-900/20 to-yellow-900/20 rounded-2xl p-5 sm:p-6 border border-amber-500/20 transition-all duration-300 hover:border-amber-500/40 hover:from-amber-900/30 h-full">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-br from-amber-500/30 to-yellow-500/30 flex items-center justify-center">
                  <Globe className="w-6 h-6 sm:w-7 sm:h-7 text-amber-200" />
                </div>
              </div>
              <div className="flex-1">
        ...
        <div className="group relative">
          <div className="bg-gradient-to-br from-yellow-900/20 to-orange-900/20 rounded-2xl p-5 sm:p-6 border border-yellow-500/20 transition-all duration-300 hover:border-yellow-500/40 hover:from-yellow-900/30 h-full">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
      ...
      <div className="relative">
        ...
        <div className="relative bg-gradient-to-r from-amber-900/30 to-yellow-900/30 rounded-xl p-4 sm:p-6 border border-amber-500/30">
